...
import com.ydeatimes.channelk.web.service.FileManager;
...
public class MediaFileController {
	...
	@ResponseBody
	@RequestMapping(value="/media/photoUpload", method=RequestMethod.POST)
	public UploadResult photoFileUploader(@RequestParam("file")MultipartFile file, @RequestParam("alt") String alt,
...
//		//서버용
		UploadResult result = fileManager.readAndSave(file, alt);
