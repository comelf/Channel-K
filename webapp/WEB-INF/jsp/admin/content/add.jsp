...
<body>
        <div id="page-wrapper">
            <div class="container-fluid">
				...
				<div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">Content 정보 추가</h1>
                        <ol class="breadcrumb">
                            <li class="active">새로운 Content 정보 를 추가합니다.</li>
                        </ol>
                    </div>
                </div>
				...
				<form:form modelAttribute="contentInfo" role="form" id="form" action="/admin/content/create" method="post" >
	                <div class="row">
	                	<div class="col-md-12">
	                		<div class="col-md-6">
		                		<div class="form-group">
		                			...
		                			<form:select path="contentCategoryId" cssClass="form-control">
		                				<c:forEach var="c" items="${contentCatetories}">
		                					<form:option value="${c.id}">${c.text}</form:option>
		                				</c:forEach>
								    </form:select>
		                		</div>
		                		<div class="form-group">
		                			<label>Content Type</label>
		                			<form:select path="contentTypeId" cssClass="form-control">
		                				<form:option value="0">Type을 선택하세요</form:option>
		                				<c:forEach var="c" items="${contentTypes}">
		                					<form:option value="${c.id}">${c.text}</form:option>
		                				</c:forEach>
								    </form:select>
		                		</div>
		                		...
		                		<div class="form-group">
									...
									<form:select path="cap" cssClass="form-control">
		                					<form:option value="0">캡 없음</form:option>
