...
<body>
        <div id="page-wrapper">
            <div class="container-fluid">
				...
				<div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">Content 추가</h1>
                        <ol class="breadcrumb">
                            <li class="active">새로운 Content 를 추가합니다.</li>
                        </ol>
                    </div>
                </div>
				...
				<form:form modelAttribute="etcContent" role="form" id="form" action="/admin/etccontent/create" method="post" >
	                <div class="row">
	                		<div class="col-md-12">
		                		...
		                		<div class="form-group">
		                			...
		                			<form:select path="content_id" cssClass="form-control">
		                				...
		                				<c:forEach var="info" items="${contentInfoList}">
		                					<form:option value="${info.id}">${info.title}</form:option>
		                				</c:forEach>
								    </form:select>
		                		</div>
		                	</div>
		                		...
		                		<div class="form-group">
								    ...
								    <form:select path="status_text" cssClass="form-control">
		                				...
		                				<c:forEach var="status" items="${contentStatusList}">
		                					<form:option value="${status.text}">${status.text}</form:option>
		                				</c:forEach>
								    </form:select>
		                		</div>
						    </div>
